      ...
      <div className="mt-4 md:mt-0">
        <FeedbackMsgList />
            ...
            {/* <div className="container mx-auto px-20 p-10 mb-[250px]  flex flex-col justify-center items-center">
                ...
                <p className="text-[16px] md:text-2xl leading-[24px]">2. <span className="text-[#077B83]">Lush Landscapes:</span>Explore the enchanting landscapes of Sri Lanka, from rolling tea plantations to mist-covered mountains and cascading waterfalls. Trek through verdant forests and marvel at the diversity of flora and fauna that thrive here.</p>
