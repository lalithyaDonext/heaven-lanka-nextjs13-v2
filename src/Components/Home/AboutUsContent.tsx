...
const AboutUsContent = () => {
  return (
    <div className="">
      ...
      <div className="container mx-auto pl-[200px] pr-[200px] flex flex-col   mt-[100px] space-y-4">
        <h1 className="text-[48px] leading-[32px] font-bold font-[volkhov]">
          <span className="text-[#077B83]">Our</span> Story
        </h1>
        <div className="ml-[50px] w-[1074px]">
      ...
      <div className="container mx-auto pl-[200px] pr-[200px] flex flex-col   mt-[70px] space-y-4">
        <h1 className="text-[48px] leading-[32px] leading-[32px] font-bold font-[volkhov]">
      ...
      <div className="mt-[90px] pt-[40px] pb-[70px]  bg-[#077B83] bg-opacity-[12%] items-center justify-center">
      ...
      <div className="container mx-auto mt-[100px] pl-[200px] pr-[200px] flex flex-col">
        <h1 className="text-[48px] font-bold font-[volkhov]">
          {" "}
      ...
      <div className="flex flex-row justify-center gap-[30px] items-center mt-[50px] pb-[330px]">
        <div className="flex flex-col  items-center  ">
          <Image
            src={profile1}
            alt="item1"
