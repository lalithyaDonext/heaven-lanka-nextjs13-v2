...
and explore the historic Madu Ganga Temple.
      ...
      <div className="flex flex-col gap-[40px] pl-[70px]">
        ...
        <div className="flex flex-row gap-[30px]">
          <Image src={Bentota2} alt="item1" className="" />
          <Image src={Bentota3} alt="item1" className="" />
          <Image src={Bentota4} alt="item1" className="" />
          <Image src={Bentota5} alt="item1" className="" />
        </div>
      </div>
      {/* --------------06 day---------- */}
      <div className="flex flex-col justify-start items-left mt-[30px] ">
